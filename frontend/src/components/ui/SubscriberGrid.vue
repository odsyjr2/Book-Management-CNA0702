                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="JoinStatus">{{ val.joinStatus }}</td>
                            <td class="whitespace-nowrap" label="KtCustomer">{{ val.ktCustomer }}</td>
                            <td class="whitespace-nowrap" label="LoginStatus">{{ val.loginStatus }}</td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <Boolean label="JoinStatus" v-model="selectedRow.joinStatus" :editMode="true"/>
                            <Boolean label="KtCustomer" v-model="selectedRow.ktCustomer" :editMode="true"/>
                            <String label="LoginStatus" v-model="selectedRow.loginStatus" :editMode="true"/>
