                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="RequestId">{{ val.requestId }}</td>
                            <td class="whitespace-nowrap" label="RequestType">{{ val.requestType }}</td>
                            <td class="whitespace-nowrap" label="TargetId">{{ val.targetId }}</td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <String label="RequestType" v-model="selectedRow.requestType" :editMode="true"/>
                            <String label="TargetId" v-model="selectedRow.targetId" :editMode="true"/>
                            <String label="RequestedAt" v-model="selectedRow.requestedAt" :editMode="true"/>
