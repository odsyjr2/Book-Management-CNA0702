                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="Introduce">{{ val.introduce }}</td>
                            <td class="whitespace-nowrap" label="Major">{{ val.major }}</td>
                            <td class="whitespace-nowrap" label="Portfolio">{{ val.portfolio }}</td>
                            <td class="whitespace-nowrap" label="RegisterStatus">{{ val.registerStatus }}</td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <String label="Introduce" v-model="selectedRow.introduce" :editMode="true"/>
                            <String label="Major" v-model="selectedRow.major" :editMode="true"/>
                            <String label="Portfolio" v-model="selectedRow.portfolio" :editMode="true"/>
                            <String label="RegisterStatus" v-model="selectedRow.registerStatus" :editMode="true"/>
